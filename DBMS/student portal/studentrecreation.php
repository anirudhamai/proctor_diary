<?php
 ...
 $q="select * from proctors where proctors.p_id=(select P_id from student where usn=$usn)";
    ...
    <div class="frame">
      <div class="card">
        ...
        <div class="profile">
          ...
          <p class="name" name="name" style="font-size: 20px">Name: <?php echo $row['p_name']; echo '<br>'; echo $row['position'];  ?></p> 
